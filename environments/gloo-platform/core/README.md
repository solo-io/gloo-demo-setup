...
grep -rl '2.4.16' ./environments/gloo-platform | xargs sed -i '' "s/\2.4.16/2.4.16/g"

git checkout environments/gloo-platform/core/README.md
```
> NOTE: where 2.4.16 is the GME dev build version without the 'v', e.g. 2.4.14-2024-04-11-v2.4.x-86a42ac5f4
